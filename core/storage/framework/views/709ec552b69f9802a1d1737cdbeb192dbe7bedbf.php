           ...
           <table class="table table-hover">
              <tbody>
                    ...
                    <tr>
                        <td>Phòng ban:</td>
                        <td>
                     <?php echo e(auth::user()->phongban->tenpb); ?>                                              
                          </td>
                    </tr>
                                                                 
                    <tr>
                        <td>Chức vụ:</td>
                        <td><?php echo e(auth::user()->chucvu->tencv); ?></td>
                    </tr>
                    <tr>
                        <td>Ngày tạo:</td>
...
</html><?php /**PATH D:\TTTT\VNPT-Internship-2.git\trunk\core\resources\views/khaosat.blade.php ENDPATH**/ ?>