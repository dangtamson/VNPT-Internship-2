                              ...
                              <table class="table table-hover table-striped">
                                  <tbody>
                                        <tr>
                                            <td>
                                              <div>
                                            <img  href="khaosat" src="https://banner2.kisspng.com/20180404/xkw/kisspng-computer-icons-survey-methodology-flat-design-survey-5ac518348189d6.3076048615228662285306.jpg" class="img-circle" alt="User Image" style="height: 75px;margin-left: 56px;">
                                            </div>
                                          ...
                                          <td>
                                              <div>
                                            <img  href="khaosat" src="images/document-edit-flat.png" class="img-circle" alt="User Image" style="height: 75px;margin-left: 60px;">
                                            </div>
                                            <center>
                                            <a href="sua"  style="margin-left: 68px;"> Đổi mật khẩu </a>
                                            </center>

                                          </td>
                                          <td>
                                              <div>
                                            <img  href="khaosat" src="https://cdn.iconscout.com/icon/premium/png-256-thumb/exit-170-753529.png" class="img-circle" alt="User Image" style="height: 75px;margin-left: 60px;">
                                            </div>
                                            <a href="/main/logout"  style="margin-left: 68px;"> Đăng xuất </a>
...
<?php /**PATH D:\TTTT\VNPT-Internship-2.git\trunk\core\resources\views/successlogin2.blade.php ENDPATH**/ ?>