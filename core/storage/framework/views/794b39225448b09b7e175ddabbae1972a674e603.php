...
<div>
					...
					<table class="table table-hover table-striped">
						...
						<tr style="background-color: white">
							<td colspan="2" align="center">
								<button type="submit" name="btn_submit" class="btn btn-success" style="width: 8em">Back</button>
							</td>
						</tr>
					</table>
				</div>
  ...
  <?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TTTT\VNPT-Internship-2.git\trunk\core\resources\views/admin/user/getpass.blade.php ENDPATH**/ ?>