...
class UserController extends Controller
{
    ...
    public function getSearch(Request $request){
        ...
        if(isset($id_user)){
            return view('admin.user.danhsach',['id_user'=>$id_user]);
        }else
        {
    ...
    public function getXoa($id){
     ...
     public function userAdmin(){
        ...
        return view('admin.user.useradmin',['ds_user'=>$ds_user]);
    }
    public function userNhanVien(){
        $ds_user = User::all()->where('quyen',1);
        return view('admin.user.usernhanvien',['ds_user'=>$ds_user]);
    }
