    ...
    <div class="container">
      <div class="row">
                 <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="header">
                    <div id="logo">
                        <p><img src="index/images1/logo1.jpg"></p>
                    </div>
                  <div id="menu">
                    <ul id="menu_top">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="slider">
          <div id="wowslider-container">
            ...
            <div class="ws_bullets">
              <div>
                <a href="#"><img src="index/images1/slide1nua.png" alt="CSS3 Slider"/></a>
                <a href="#"><img src="index/images1/slide2nua.png" alt="CSS Slideshow"/></a>
                <a href="#"><img src="index/images1/slide3.png" alt="CSS Gallery"/></a>
                <a href="#"><img src="index/images1/slide6.jpg" alt="How to create a slider in 7 seconds"/></a>
